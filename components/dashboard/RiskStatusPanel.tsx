      ...
      <div className="space-y-6">
        <div className="p-5 rounded-xl bg-[#F9FAFB] dark:bg-[#1E2330] border border-[#ECE8E3] dark:border-[#2B3139]">
          <div className="flex justify-between items-end mb-3">
            ...
            <span className="text-xl font-black font-mono text-[#C7A86D]">{exposure}% <span className="text-[10px] opacity-40">/ {limit}%</span></span>
          </div>
